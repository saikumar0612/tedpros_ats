...
describe('ViewJobComponent', () => {
  ...
  // getpublishJob
  it('#getpublishJob', fakeAsync(() => {
    component.id = 'SMLJB0015';
    component.getpublishJob();
    tick();
    expect(component.isShowPopup).toBe(true);
    expect(component.error).toEqual(null);
    expect(component.message).toEqual('Job Published successfully');
  }));
  // closePopup
  ...
  it('#ngOnInit', fakeAsync(() => {
    ...
    component.ngOnInit();
    tick();
    expect(component.id).toEqual('SMLJB0015');
