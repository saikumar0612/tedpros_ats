...
describe('EditJobsComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [EditJobsComponent], providers: [
  ...
  it('#checkPublishBill', fakeAsync(() => {
    ...
    component.checkPublishBill(event);
    tick();
  ...
  it('#getcontacts', fakeAsync(() => {
    component.getcontacts(contactId);
    tick();
  ...
  it('#addSkill', fakeAsync(() => {
    ...
    component.addSkill(myFrm, '', '', 'experience');
    tick();
    expect(component.skillBool).toEqual('Please specify valid skill');
    component.addSkill(myFrm, 'skill', 'name', 'experience');
    tick();
  ...
  it('#ngOnInit', fakeAsync(() => {
    component.jobData.internalCode = internalCode;
    component.ngOnInit();
    tick();
    expect(component.dropdownSettings.singleSelection).toBe(true);
