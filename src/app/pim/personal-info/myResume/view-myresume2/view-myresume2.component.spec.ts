...
import { ViewMyresume2Component } from './view-myresume2.component';
...
describe('ViewMyresume2Component', () => {
  let component: ViewMyresume2Component;
  let fixture: ComponentFixture<ViewMyresume2Component>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ViewMyresume2Component],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ViewMyresume2Component);
