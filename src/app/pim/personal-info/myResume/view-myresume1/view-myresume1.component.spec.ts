...
import { ViewMyresume1Component } from './view-myresume1.component';
...
describe('ViewMyresume1Component', () => {
  let component: ViewMyresume1Component;
  let fixture: ComponentFixture<ViewMyresume1Component>;
  ...
  const skills = [
    ...
    },
    {
      ...
      "otherSkill": "Angular",
      "status": "2",
      "lastUsed": "January/2018"
    }
  ];

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ViewMyresume1Component],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ViewMyresume1Component);
  ...
  it('#captureScreen', fakeAsync(() => {
    component.captureScreen();
    tick();
    expect(component.informationData.firstName).toEqual('pavan');
  }));

  it('#onChartClick', fakeAsync(() => {
  ...
  it('#ngOnInit', fakeAsync(() => {
    component.ngOnInit();
    tick();
    expect(component.skillsData).toEqual(skills);
  }));
});
