...
@Component({
  selector: 'app-view-myresume1',
  templateUrl: './view-myresume1.component.html',
  styleUrls: ['./view-myresume1.component.css']
})
export class ViewMyresume1Component implements OnInit {
