...
describe('QualificationsComponent', () => {
  ...
  it('#ngOnInit', fakeAsync(() => {
    component.ngOnInit();
    tick();
    expect(component.displayyear).toBe(false);
  }));
  ...
  it('#editWork', fakeAsync(() => {
    component.editWork();
    tick();
    expect(component.displayExp).toBe(true);
  }));

  it('#backWork', fakeAsync(() => {
    component.backWork();
    tick();
    expect(component.displayExp).toBe(false);
  }));

  it('#editEdu', fakeAsync(() => {
    component.editEdu();
    tick();
    expect(component.displayEdu).toBe(true);
  }));

  it('#backEdu', fakeAsync(() => {
    component.backEdu();
    tick();
    expect(component.displayEdu).toBe(false);
  }));

  it('#editSkill', fakeAsync(() => {
    component.editSkill();
    tick();
    expect(component.displaySkill).toBe(true);
  }));

  it('#backSkill', fakeAsync(() => {
    component.backSkill();
    tick();
    expect(component.displaySkill).toBe(false);
  }));

  it('#editLang', fakeAsync(() => {
    component.editLang();
    tick();
    expect(component.displayLang).toBe(true);
  }));

  it('#backLang', fakeAsync(() => {
    component.backLang();
    tick();
    expect(component.displayLang).toBe(false);
  }));

  it('#editLicense', fakeAsync(() => {
    component.editLicense();
    tick();
    expect(component.displayLicense).toBe(true);
  }));

  it('#backLicense', fakeAsync(() => {
    component.backLicense();
    tick();
    expect(component.displayLicense).toBe(false);
  }));

  it('#onchange', fakeAsync(() => {
    component.onchange('Certification');
    tick();
    expect(component.showlicense).toBe(false);
    component.onchange('License');
    tick();
    expect(component.showlicense).toBe(true);
  }));
