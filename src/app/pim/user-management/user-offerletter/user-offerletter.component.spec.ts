...
import { UserOfferletterComponent } from './user-offerletter.component';

describe('UserOfferletterComponent', () => {
  let component: UserOfferletterComponent;
  let fixture: ComponentFixture<UserOfferletterComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [UserOfferletterComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(UserOfferletterComponent);
