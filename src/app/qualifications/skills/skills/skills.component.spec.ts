...
describe('SkillsComponent', () => {
  ...
  it("#ngonint", fakeAsync(() => {
    component.ngOnInit();
    tick();
    userServiceStub.getSkills()
      .pipe(map(response => {
        component.skills = response.json().data;
        component.filterData = component.skills;
  ...
  it('#search', fakeAsync(() => {
    ...
    tick();
    expect(component.filterData.length).toEqual(component.skills.length);
