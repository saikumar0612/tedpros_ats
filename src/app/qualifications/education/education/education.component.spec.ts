...
describe('EducationComponent', () => {
  ...
  it("#ngonint", fakeAsync(() => {
    component.ngOnInit();
    tick();
    userServiceStub.getEducation()
      .pipe(map(response => {
        component.educations = response.json().data;
        component.filterData = component.educations;
  ...
  it('#search', fakeAsync(() => {
    ...
    tick();
    expect(component.filterData.length).toEqual(component.educations.length);
