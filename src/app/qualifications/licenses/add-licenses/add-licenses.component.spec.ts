...
import { AddLicensesComponent } from './add-licenses.component';
...
describe('AddLicensesComponent', () => {
  let component: AddLicensesComponent;
  let fixture: ComponentFixture<AddLicensesComponent>;
  const userServiceStub = new UserServiceStub();
  const locationStub = new LocationStub();
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [AddLicensesComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddLicensesComponent);
  ...
  it('#add licences ', fakeAsync(() => {
    const myFrm: NgForm = new NgForm([], []);
    component.addLicense(myFrm);
    tick()
    expect(component.lic.statusCode.code).toEqual("200");
