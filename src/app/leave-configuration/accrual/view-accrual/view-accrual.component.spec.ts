...
import { ViewAccrualComponent } from './view-accrual.component';

describe('ViewAccrualComponent', () => {
  let component: ViewAccrualComponent;
  let fixture: ComponentFixture<ViewAccrualComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ViewAccrualComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(ViewAccrualComponent);
