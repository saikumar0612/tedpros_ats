...
import { EditAccrualComponent } from './edit-accrual.component';

describe('EditAccrualComponent', () => {
  let component: EditAccrualComponent;
  let fixture: ComponentFixture<EditAccrualComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [EditAccrualComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(EditAccrualComponent);
