...
import { AccrualListComponent } from './accrual-list.component';

describe('AccrualListComponent', () => {
  let component: AccrualListComponent;
  let fixture: ComponentFixture<AccrualListComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [AccrualListComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(AccrualListComponent);
  ...
  it('#search', fakeAsync(() => {
    component.entitlementData = [];
    let term = null;
    let key = null;
    component.search(term, key);
    tick();
    expect(component.filterData.length).toEqual(component.entitlementData.length);
