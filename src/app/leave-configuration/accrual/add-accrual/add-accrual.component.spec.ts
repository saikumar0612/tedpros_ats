...
import { AddAccrualComponent } from './add-accrual.component';

describe('AddAccrualComponent', () => {
  let component: AddAccrualComponent;
  let fixture: ComponentFixture<AddAccrualComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [AddAccrualComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(AddAccrualComponent);
