...
import { EditEntitlementsComponent } from './edit-entitlements.component';

describe('EditEntitlementsComponent', () => {
  let component: EditEntitlementsComponent;
  let fixture: ComponentFixture<EditEntitlementsComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [EditEntitlementsComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(EditEntitlementsComponent);
