...
export class PreviewComponent implements OnInit {
  ...
  constructor( private router: Router, private blocation: Location, private service:VmsCandidateService, private route:ActivatedRoute) {
  }
  ...
  ngOnInit() {
    // this.candidateDetails = this.candidateUser.data;
    // this.candidateData = this.candidateDetails;
