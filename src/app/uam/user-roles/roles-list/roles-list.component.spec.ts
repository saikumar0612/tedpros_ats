...
describe('RolesListComponent', () => {
  ...
  let fixture: ComponentFixture<RolesListComponent>; const userServiceStub = new UserServiceStub();
  ...
  it('#ngOnInit', fakeAsync(() => {
    component.roles = [];
    userServiceStub.getRolesList().pipe(map(res => {
      component.roles = res.json().data;
    }));
    tick();
    component.ngOnInit();
    expect(component.loading).toBe(false);
    expect(component.availableRecords).toEqual(component.roles.length);
  }));
  ...
  it('#search', fakeAsync(() => {
    ...
    tick();
    expect(component.filterData).toEqual(component.roles);
    term = 'testTerm';
    key = 'role_name';
    component.search(term, key);
    tick();
