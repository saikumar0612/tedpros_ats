...
import { EdtiTermsConditionsComponent } from './edti-terms-conditions.component';
...
describe('EdtiTermsConditionsComponent', () => {
  let component: EdtiTermsConditionsComponent;
  let fixture: ComponentFixture<EdtiTermsConditionsComponent>;
  const userServiceStub = new UserServiceStub();
  const locationStub = new LocationStub();
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [EdtiTermsConditionsComponent],
      providers: [
      ...
      imports: [
        ...
        ImageCropperModule,
        ChartsModule,
        RouterTestingModule, CKEditorModule,
        SharedModule
      ]
    })
      .compileComponents();
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EdtiTermsConditionsComponent);
  ...
  it('#ngOnInit', fakeAsync(() => {
    component.ngOnInit();
    tick();
    userServiceStub.getTermsConditions()
      .pipe(map(response => {
