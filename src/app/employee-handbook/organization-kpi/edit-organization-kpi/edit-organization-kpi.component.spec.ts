...
import { EditOrganizationKpiComponent } from './edit-organization-kpi.component';
...
describe('EditOrganizationKpiComponent', () => {
  let component: EditOrganizationKpiComponent;
  let fixture: ComponentFixture<EditOrganizationKpiComponent>;
  const userServiceStub = new UserServiceStub();
  const locationStub = new LocationStub();
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [EditOrganizationKpiComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EditOrganizationKpiComponent);
  ...
  it('#ngOnInit', fakeAsync(() => {
    component.ngOnInit();
    tick();
    userServiceStub.getOrganizationalKpiById('1')
      .pipe(map(response => {
        component.kpiData = response.json().data;
      }))
  }));
  it('#cancel', fakeAsync(() => {
  ...
  it('#checkrating', fakeAsync(() => {

    component.checkrating();
    tick();
    expect(component.rateerror).toEqual('');
  }));
  it('#editKpi', fakeAsync(() => {

    component.editKpi();
    tick();
    expect(component.kpiDetails.statusCode.code).toEqual('200');
    expect(component.isShowPopup).toBe(true);
    expect(component.message).toEqual("Data successfully edited");
  }));
