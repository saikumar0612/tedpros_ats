...
import { AddOrganizationKpiComponent } from './add-organization-kpi.component';
...
describe('AddOrganizationKpiComponent', () => {
  let component: AddOrganizationKpiComponent;
  let fixture: ComponentFixture<AddOrganizationKpiComponent>;
  const userServiceStub = new UserServiceStub();
  const locationStub = new LocationStub();
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [AddOrganizationKpiComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddOrganizationKpiComponent);
