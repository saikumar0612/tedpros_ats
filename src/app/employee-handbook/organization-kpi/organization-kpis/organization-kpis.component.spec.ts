...
import { OrganizationKpisComponent } from './organization-kpis.component';
...
describe('OrganizationKpisComponent', () => {
  let component: OrganizationKpisComponent;
  let fixture: ComponentFixture<OrganizationKpisComponent>;
  const userServiceStub = new UserServiceStub();
  const locationStub = new LocationStub();

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [OrganizationKpisComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(OrganizationKpisComponent);
  ...
  it('#ngOnInit', fakeAsync(() => {
    component.ngOnInit();
    tick();
    userServiceStub.getOrganizationKPI()
      .pipe(map(response => {
        component.kpis = response.json().data;
      }))
    expect(component.filterData.length).toEqual(component.kpis.length);
  ...
  it('#showKpiDetails', fakeAsync(() => {
    // component.isShowPopup=true;
    component.showKpiDetails('1');
    tick();
