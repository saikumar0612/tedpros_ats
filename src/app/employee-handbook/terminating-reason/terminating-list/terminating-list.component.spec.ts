...
import { TerminatingListComponent } from './terminating-list.component';
...
describe('TerminatingListComponent', () => {
  let component: TerminatingListComponent;
  let fixture: ComponentFixture<TerminatingListComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [TerminatingListComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TerminatingListComponent);
  ...
  it('#ngOnInit', fakeAsync(() => {
    component.ngOnInit();
    tick();
    userServiceStub.getTerminationRules()
      .pipe(map(response => {
        component.termination = response.json().data;
      }));
    expect(component.filterData.length).toEqual(component.termination.length);
  }));
