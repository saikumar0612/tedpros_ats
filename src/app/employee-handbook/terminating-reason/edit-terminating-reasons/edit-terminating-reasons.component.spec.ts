...
import { EditTerminatingReasonsComponent } from './edit-terminating-reasons.component';
...
describe('EditTerminatingReasonsComponent', () => {
  let component: EditTerminatingReasonsComponent;
  let fixture: ComponentFixture<EditTerminatingReasonsComponent>;
  const userServiceStub = new UserServiceStub();
  const locationStub = new LocationStub();
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [EditTerminatingReasonsComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EditTerminatingReasonsComponent);
  ...
  it('#ngOnInit', fakeAsync(() => {
    component.ngOnInit();
    tick();
    userServiceStub.getTermination('1')
      .pipe(map(response => {
        component.terminationInfo = response.json().data;
      }));
  ...
  it('#editReason', fakeAsync(() => {
    component.editReason();
    tick();
    expect(component.reason.statusCode.code).toEqual('200');
