...
import { OfficeDocumentsComponent } from './office-documents.component';
...
describe('OfficeDocumentsComponent', () => {
  let component: OfficeDocumentsComponent;
  let fixture: ComponentFixture<OfficeDocumentsComponent>;
  const userServiceStub = new UserServiceStub();
  const locationStub = new LocationStub();

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [OfficeDocumentsComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(OfficeDocumentsComponent);
