...
import { ViewPrerequisiteDocComponent } from './view-prerequisite-doc.component';
...
describe('ViewPrerequisiteDocComponent', () => {
  let component: ViewPrerequisiteDocComponent;
  let fixture: ComponentFixture<ViewPrerequisiteDocComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ ViewPrerequisiteDocComponent ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ViewPrerequisiteDocComponent);
