...
import { AddPrerequisiteDocComponent } from './add-prerequisite-doc.component';
...
describe('AddPrerequisiteDocComponent', () => {
  let component: AddPrerequisiteDocComponent;
  let fixture: ComponentFixture<AddPrerequisiteDocComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ AddPrerequisiteDocComponent ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddPrerequisiteDocComponent);
  ...
  it('#addTemplate - 400 response', () => {
    spyOn(userServiceStub,'addPrerequisiteDoc').and.returnValues(of({
      json: function() {
        return {
          statusCode: {
              code: '400',
