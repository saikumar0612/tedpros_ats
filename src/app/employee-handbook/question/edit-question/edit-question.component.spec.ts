...
describe('EditQuestionComponent', () => {
  ...
  it('#getQuestionById', fakeAsync(() => {
    component.getQuestionById();
    tick();
  }));

  it('#getQuestionById - 400 response', () => {
    spyOn(userServiceStub,'getQuestionById').and.returnValues(of({
      json: function() {
        return {
          statusCode: {
              code: '400',
  ...
  it('#editQuestion', fakeAsync(() => {
    component.editQuestion();
    tick();
    expect(component.successPopup).toBe(true);
  }));

  it('#editQuestion - 400 response', () => {
    spyOn(userServiceStub,'editQuestion').and.returnValues(of({
      json: function() {
        return {
          statusCode: {
              code: '400',
