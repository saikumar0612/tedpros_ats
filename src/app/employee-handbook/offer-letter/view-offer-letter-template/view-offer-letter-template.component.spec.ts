...
import { ViewOfferLetterTemplateComponent } from './view-offer-letter-template.component';
...
describe('ViewOfferLetterTemplateComponent', () => {
  let component: ViewOfferLetterTemplateComponent;
  let fixture: ComponentFixture<ViewOfferLetterTemplateComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ViewOfferLetterTemplateComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ViewOfferLetterTemplateComponent);
