...
import { AddOfferletterTypeComponent } from './add-offerletter-type.component';
...
describe('AddOfferletterTypeComponent', () => {
  let component: AddOfferletterTypeComponent;
  let fixture: ComponentFixture<AddOfferletterTypeComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ AddOfferletterTypeComponent ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddOfferletterTypeComponent);
  ...
  it('#addTemplate', fakeAsync(() => {
    ...
    tick();
    userServiceStub.addOfferLetterType(component.data)
      .pipe(map(response => {
