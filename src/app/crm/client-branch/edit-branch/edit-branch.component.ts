...
export class EditBranchComponent implements OnInit {
  ...
  constructor(private eventEmitterService: EventEmitterService, private route: ActivatedRoute, public http: Http,
    ...
    this.route.paramMap.subscribe(
      param => {
        ...
        this.logger.actionTitle = 'Edit Client branch';
        this.logger.comment = 'Edit client branch by Id as ' + this.cusInfo.id;
  ...
  getCompanyInfo() {
    ...
    this.service.getCustomersList(this.id)
      .subscribe(response => {
        ...
        if (this.cusInfo) {
          this.getParent(this.cusInfo.hqId);
        }
  ...
  editCus() {
    ...
    this.service.editClientBranch(this.cusInfo)
      .subscribe(response => {
