...
import { ViewVendorContactComponent } from './view-vendor-contact.component';
...
describe('ViewVendorContactComponent', () => {
  let component: ViewVendorContactComponent;
  let fixture: ComponentFixture<ViewVendorContactComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ViewVendorContactComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ViewVendorContactComponent);
  ...
  it('#ngOnInit', fakeAsync(() => {
    ...
    expect(component.id).toEqual('42');
  }));
