...
import { EditVendorContactComponent } from './edit-vendor-contact.component';
...
describe('EditVendorContactComponent', () => {
  ...
  it('#getAddress', fakeAsync(() => {
    component.contactInfo.address.zipCode = '25259';
    component.getAddress();
    tick();
    expect(component.contactInfo.countryId).toEqual('231');
  }));

  it('#checkContact', fakeAsync(() => {
    component.checkContact();
    tick();
    expect(component.contactInfo.userId).toEqual('1');
  }));

  it('#dateValidate', fakeAsync(() => {
    component.contactInfo.personalInfo.doBirth = 'Mon Sep 23 2019 00:00:00 GMT+0530 (India Standard Time)';
    ...
    component.contactInfo.personalInfo.doBirth = 'Mon Feb 10 2019 00:00:00 GMT+0530 (India Standard Time)';
    component.dateValidate();
    tick();
  ...
  it('#dateValidate1', fakeAsync(() => {
    component.contactInfo.personalInfo.doBirth = 'Mon Sep 23 2019 00:00:00 GMT+0530 (India Standard Time)';
    component.contactInfo.personalInfo.anniversary = 'Sun Sep 22 2019 00:00:00 GMT+0530 (India Standard Time)';
    // Sun Sep 22 2019 00:00:00 GMT+0530 (India Standard Time)
    ...
    component.contactInfo.personalInfo.doBirth = 'Mon Feb 10 2019 00:00:00 GMT+0530 (India Standard Time)';
    component.contactInfo.personalInfo.anniversary = 'Thu Sep 22 2016 00:00:00 GMT+0530 (India Standard Time)';
    component.dateValidate1();
    tick();
    expect(component.dateError1).toEqual('');
  }));

  it('#editCom', fakeAsync(() => {
    component.editCom();
    tick();
    expect(component.message).toEqual('Client company Contact Updated Successfully');
  }));
  ...
  it('#refresh', fakeAsync(() => {
    ...
    expect(component.contactInfo.id).toEqual('42');
