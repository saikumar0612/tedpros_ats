...
export class AuthServiceStub {
    // modification done by BASIT022 strat * 3rd Aug 2019
    getTheme() {
                ...
                return {
                    ...
                    "data": [
                        ...
                        },
                        {
                            ...
                            "datePosted": "2005-01-01",
                            "targetDate": "2005-01-01",
                            "recruiter": {
                                "userId": "SMU1014",
                                "firstName": "Saigeeta",
                                "lastName": "Konchada"
                        ...
                        },
                        {
                            ...
                            "datePosted": "2011-05-16",
                            "targetDate": "2019-07-18",
                            "recruiter": {
                                "userId": "gst1289",
                                "firstName": "satya",
                                "lastName": "t"
                        ...
                        },
                        {
                            ...
                            "datePosted": "2016-04-20",
                            "targetDate": "2019-07-23",
                            "recruiter": null,
                            "openings": "4",
                            "jobStatus": "Open",
                            "status": "Active",
                        ...
                        },
                        {
                            ...
                            "datePosted": "2018-08-13",
                            "targetDate": "2018-08-15",
                            "recruiter": {
                                "userId": "SMU1002",
                                "firstName": "James",
                                "lastName": "Smith"
                        ...
                        },
                        {
                            ...
                            "datePosted": "2019-07-20",
                            "targetDate": "2019-07-25",
                            "recruiter": {
                                "userId": "SMU1002",
                                "firstName": "James",
                                "lastName": "Smith"
                        ...
                        },
                        {
                            ...
                            "skill": [
                                {
                                    "skillName": "Systems Analysis and Design."
                                }
                            ],
                            "perHour": {
                                "id": "2",
                            ...
                            "billRate": "12",
                            "description": "<p>Information security managers&nbsp;are responsible for protecting their organization&#39;s computers, networks and data against threats, such as&nbsp;security&nbsp;breaches, computer viruses or attacks by&nbsp;cyber-criminals. ... That makes the&nbsp;job&nbsp;of the&nbsp;information security manager&nbsp;strategically important.</p>\n\n<p><strong>Skills required are</strong>:</p>\n\n<ul>\n\t<li>computer networks</li>\n\t<li>Systems Analysis and Design.</li>\n</ul>\n",
                            "employmentType": "Part Time"
                        },
                        {
                            "id": "4",
                            "internalCode": "SMLJB0007",
                            "jobCode": "12",
                            "country": {
                                "id": "231",
                                "name": "United States"
                            ...
                            "billRate": "5000",
                            "description": "this is the job opening for tester",
                            "employmentType": "Contract"
                        },
                        {
                            "id": "3",
                            "internalCode": "SMLJB0006",
                            "jobCode": "AM2222",
                            "country": {
                                "id": "231",
                                "name": "United States"
            ...
            json: function () {
                return {
                    ...
                    "data": {
                        "first_name": "Smith",
                        "last_name": "Mike",
                        "email": "smlogics35@gmail.com",
                        "phone": "8954123698",
                        "isNew": "1"
                    },
                    "token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6MTA5LCJlbWFpbCI6InNtbG9naWNzMzVAZ21haWwuY29tIiwiaWF0IjoxNTY5MzE4MTIyLCJleHAiOjE1NjkzMjE3MjJ9.trW1kklxiAcER9afT-fRKkjiuy1OAlGgAte6uwvPtVM"
                }
            }
        })
    }
        ...
        return of({
            json: function () {
                return {
                    ...
                    "token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEwOSIsImVtYWlsIjoic21sb2dpY3MzNUBnbWFpbC5jb20iLCJpYXQiOjE1Njk0MDg3NDYsImV4cCI6MTU2OTQxMjM0Nn0.RGywTK199zBaE5conmW4LxwGNsRo1v-5TreoCa1ppNk"
                }
            }
        })
    }

    candidateactivationlogin(username, password) {
        return of({
            json: function () {
                return {
                    statusCode: {
                    ...
                    "token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjY5IiwiZW1haWwiOiJzbWxvZ2ljczM1QGdtYWlsLmNvbSIsImlhdCI6MTU2OTQwOTQwNiwiZXhwIjoxNTY5NDEzMDA2fQ.3cEyYN1IsVic6EVBxTvzT9tSI1UGUwAItAr_8IWi1cc"
                }
            }
        })
    }
    ...
    candidateForgetPassword(emailId) {
        return of({
            json: function () {
                return {
                    token: "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6InNtbG9naWNzMkBnbWFpbC5jb20iLCJpZCI6IjY0IiwiaWF0IjoxNTY5NjQ0MTU0LCJleHAiOjE1Njk2NDc3NTR9.jIBKcdkeXaNhhnSslWUZe98Cgl9uST9kmkxsTuWAeqc",
                    statusCode: {
                        code: "200",
                        message: "ok"
                    },
                    errorMessages: null,
                    data: "Reset Link mailed to your email"
                }
            }
        })
    }
            ...
            json: function () {
                return {
                    ...
                    "data": {
                        ...
                        "techJobTitle": "Java and C Developer",
                        "datePosted": "2019-03-05",
                        "targetDate": "2005-03-05",
                        "priority": "High",
                        "employmentType": "Full Time",
    ...
    // added suresh 10-09-2019 start
    // added suresh 09-25-2019 end

    getBaseUrl() {
        return "https://162.254.209.129/accountadmin/";
    }

    // modification done by BASIT022 end * 3rd Aug 2019
    logout() {
