...
import { ViewMyWeekTimesheetComponent } from './view-my-week-timesheet.component';
...
describe('ViewMyWeekTimesheetComponent', () => {
  let component: ViewMyWeekTimesheetComponent;
  let fixture: ComponentFixture<ViewMyWeekTimesheetComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ViewMyWeekTimesheetComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ViewMyWeekTimesheetComponent);
