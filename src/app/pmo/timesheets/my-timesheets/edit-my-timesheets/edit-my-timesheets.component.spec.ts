...
import { EditMyTimesheetsComponent } from './edit-my-timesheets.component';

describe('EditMyTimesheetsComponent', () => {
  let component: EditMyTimesheetsComponent;
  let fixture: ComponentFixture<EditMyTimesheetsComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ EditMyTimesheetsComponent ]
    })
    .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(EditMyTimesheetsComponent);
