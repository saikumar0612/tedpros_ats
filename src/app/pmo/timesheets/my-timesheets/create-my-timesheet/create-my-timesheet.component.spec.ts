...
import { CreateMyTimesheetComponent } from './create-my-timesheet.component';

describe('CreateMyTimesheetComponent', () => {
  let component: CreateMyTimesheetComponent;
  let fixture: ComponentFixture<CreateMyTimesheetComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ CreateMyTimesheetComponent ]
    })
    .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(CreateMyTimesheetComponent);
