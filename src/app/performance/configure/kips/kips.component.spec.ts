...
import { KipsComponent } from './kips.component';

describe('KipsComponent', () => {
  let component: KipsComponent;
  let fixture: ComponentFixture<KipsComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [KipsComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(KipsComponent);
