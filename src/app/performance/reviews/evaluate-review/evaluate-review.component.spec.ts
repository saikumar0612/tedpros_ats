...
import { EvaluateReviewComponent } from './evaluate-review.component';

describe('EvaluateReviewComponent', () => {
  let component: EvaluateReviewComponent;
  let fixture: ComponentFixture<EvaluateReviewComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [EvaluateReviewComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(EvaluateReviewComponent);
