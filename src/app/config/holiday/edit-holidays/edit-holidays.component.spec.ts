...
describe('EditHolidaysComponent', () => {
  ...
  it('#ngOnInit', fakeAsync(() => {
    component.ngOnInit();
    tick();
    userServiceStub.getHolidayById('21').subscribe(res => {
      component.holidayData = res.json().data;
  ...
  it("#editHoliday", fakeAsync(() => {
    component.editHoliday();
    tick();
    expect(component.holiday.statusCode.code).toEqual('200');
