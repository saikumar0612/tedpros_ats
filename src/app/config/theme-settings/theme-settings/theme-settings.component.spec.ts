...
describe('ThemeSettingsComponent', () => {
  ...
  it('#ngOnInit', fakeAsync(() => {
    ...
    component.currentUser.token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJ1c2VybmFtZSI6ImFkbWluIiwiaWF0IjoxNTY0Mzc1MDQ5LCJleHAiOjE1NjQzOTMwNDl9.-3yio6X4qo2fUtHSUhak6gk819ljC6BlStjgd1KrbK4';
    component.ngOnInit();
    tick();
  ...
  it('#addColor', fakeAsync(() => {

    component.addColor();
    tick();
    expect(component.colorData.code).toEqual('200');
