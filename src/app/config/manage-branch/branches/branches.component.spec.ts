...
describe('BranchesComponent', () => {
  ...
  it("#ngOnInit", fakeAsync(() => {
    ...
    component.ngOnInit();
    tick();
    userServiceStub.getCompanyBranches().pipe(map(res => {
      component.result = res.json();
  ...
  it("#getAddress", fakeAsync(() => {
    ...
    component.getAddress(component.branch.registeredAddress.zipcode);
    tick();
