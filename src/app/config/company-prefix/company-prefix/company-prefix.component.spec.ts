...
import { CompanyPrefixComponent } from './company-prefix.component';
...
describe('CompanyPrefixComponent', () => {
  let component: CompanyPrefixComponent;
  let fixture: ComponentFixture<CompanyPrefixComponent>;
  const userServiceStub = new UserServiceStub();
  const locationStub = new LocationStub();
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [CompanyPrefixComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CompanyPrefixComponent);
  ...
  it('#ngOnInit', fakeAsync(() => {
    ...
    userServiceStub.viewCompnayInfo().pipe(map(res => {
      component.compnayInfo = res.json().data;
    }));
    userServiceStub.companySettings().pipe(map(res => {
      component.prefixInfo = res.json().data;
    }));
  }))

  it("#addPrefix", fakeAsync(() => {
