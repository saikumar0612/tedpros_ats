...
describe('WorkshiftsComponent', () => {
  ...
  it("#search",fakeAsync(()=>{
    ...
    tick();
    expect(component.filterData.length).toEqual(component.shifts.length);
...
it('#ngOnInit',fakeAsync(()=>{
  component.ngOnInit();
  tick();
  userServiceStub.getWorkShifts().pipe(map(res=>{
    component.shifts = res.json().data;
    component.filterData = component.shifts;
  }))
