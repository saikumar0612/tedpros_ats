...
import { AddPayGradeComponent } from './add-pay-grade.component';
...
describe('AddPayGradeComponent', () => {
  let component: AddPayGradeComponent;
  let fixture: ComponentFixture<AddPayGradeComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [AddPayGradeComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddPayGradeComponent);
