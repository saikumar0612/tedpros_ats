...
describe('EmployeeTypeComponent', () => {
  ...
  it("#ngOnInit", fakeAsync(() => {
    ...
    expect(component.availableRecords).toEqual(component.emptypes.length);
  }))
  ...
  it("#showUserDetails", fakeAsync(() => {
    ...
    component.emptypes = [{ 'id': '1', 'name': 'projleadceo' },
  ...
  it('#search', fakeAsync(() => {
    ...
    tick();
    expect(component.filterData.length).toEqual(component.emptypes.length);
