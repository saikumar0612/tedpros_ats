    ...
    t.prototype = {
        ...
        getNodeState: function(e, t) {
            var i = {},
                n = e.parent().is("li");
            if ("parent" === (t = t || "self")) {
                if (n ? (i = e.closest("ul").parents("ul")).length || (i = e.closest(".nodes")).length || (i = e.closest(".verticalNodes").siblings(":first")) : i = e.closest(".nodes").siblings(":first"), i.length) return i.is(".hidden") || !i.is(".hidden") && i.closest(".nodes").is(".hidden") || !i.is(".hidden") && i.closest(".verticalNodes").is(".hidden") ? {
                    exist: !0,
                    visible: !1
                } : {
                    exist: !0,
                ...
                if ((i = n ? e.parent().children("ul") : e.closest("tr").siblings(":last")).length) return i.is(".hidden") ? {
                    exist: !0,
                    visible: !1
                } : {
                    exist: !0,
                ...
                if ((i = n ? e.closest("ul") : e.closest("table").parent().siblings()).length && (!n || 1 < i.children("li").length)) return i.is(".hidden") || i.parent().is(".hidden") || n && i.closest(".verticalNodes").is(".hidden") ? {
                    exist: !0,
                    visible: !1
                } : {
                    exist: !0,
        ...
        dragoverHandler: function(e) {
            u(e.delegateTarget).is(".allowedDrop") ? e.preventDefault() : e.originalEvent.dataTransfer.dropEffect = "none"
        },
        ...
        export: function(t, i) {
            ...
            html2canvas(a, {
                width: o ? a.clientHeight : a.clientWidth,
                height: o ? a.clientWidth : a.clientHeight,
                onclone: function(e) {
